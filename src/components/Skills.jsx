...
const skillContainer =
  "flex flex-col p-3 gap-6 md:grid grid-cols-1 grid-rows-auto";
const skillWrapper =
  "flex flex-col justify-center items-center bg-gray-950 py-4 p-3 rounded-xl border border-lime-800 hover:border-lime-600 duration-500";
const skillTitle =
  "text-amber-600 lg:text-2xl text-xl font-semibold text-center my-3";
